...
MenuTexture* gGlyphTextureLUT[] = {
    seg2_textureFontLetterA, seg2_textureFontLetterB, seg2_textureFontLetterC, seg2_textureFontLetterD, seg2_textureFontLetterE, seg2_textureFontLetterF, seg2_textureFontLetterG, seg2_textureFontLetterH, seg2_textureFontLetterI,
    seg2_textureFontLetterJ, seg2_textureFontLetterK, seg2_textureFontLetterL, seg2_textureFontLetterM, seg2_textureFontLetterN, seg2_textureFontLetterO, seg2_textureFontLetterP, seg2_textureFontLetterQ, seg2_textureFontLetterR,
    seg2_textureFontLetterS, seg2_textureFontLetterT, seg2_textureFontLetterU, seg2_textureFontLetterV, seg2_textureFontLetterW, seg2_textureFontLetterX, seg2_textureFontLetterY, seg2_textureFontLetterZ, seg2_textureFontExclamationMark,
    seg2_textureFontMinus, seg2_textureFontInterogationMark, seg2_textureFontSimpleQuote, seg2_textureFontEmpty, seg2_textureFontDot, seg2_textureFontNumberZero, seg2_textureFontNumberOne, seg2_textureFontNumberTwo, seg2_textureFontNumberThree,
    seg2_textureFontNumberFour, seg2_textureFontNumberFive, seg2_textureFontNumberSix, seg2_textureFontNumberSeven, seg2_textureFontNumberEight, seg2_textureFontNumberNine, seg2_textureFontDoubleQuote, seg2_textureFontFourDote, seg2_textureFontPlus,
    seg2_textureFontCC, seg2_textureFontComma, seg2_textureFontEmpty, D_02002824, D_0200284C, D_02002874, D_0200289C, D_020028C4, D_020028EC,
...
MenuTexture* D_800E8254[] = {
    ...
    seg2_menu_4p_column,      D_0200487C,          D_020048A4,          seg2_textureMenuRData,
};
...
void draw_fade_in(s32 arg0, s32 arg1, s32 arg2) {
    ...
    gDisplayListHead = draw_box(gDisplayListHead, x - (w / 2), y - (h / 2), (w / 2) + x, (h / 2) + y, color->red,
                                color->green, color->blue, 0xFF - (gCurrentTransitionTime[arg0] * 0xFF / gTransitionDuration[arg0]));

    if ((arg1 == 0) && (gCurrentTransitionTime[arg0] += 1, (gCurrentTransitionTime[arg0] >= gTransitionDuration[arg0]))) {
        if (gGamestate == RACING) {
...
void func_8009DB8C(void) {
    ...
    if ((u32) var_v1 >= gTransitionDuration[4]) {
        ...
        while (var_s3 < (0x4B0U / gTransitionDuration[4])) {
            if ((sTKMK00_LowResBuffer[var_s0] == 0) && (random_int((0x4B0U - gCurrentTransitionTime[4]) / gTransitionDuration[4]) == 0)) {
                var_s3 += 1;
                sTKMK00_LowResBuffer[var_s0] = 1;
            }
            var_s0 += 1;
...
void render_custom_overlay(void) {
    ...
    print_text1_left(x + 0x78, y + 0x06, "TE V2026-09-02 NETPLAY 1.0", 0, 0.65f, 0.65f);
    ...
    for (playerId = 0; playerId < gPlayerCount; playerId++) {
        ...
        switch (gModeSelection) { /* irregular */
            case VERSUS:
                ...
                var_s4 = &nmi_gVersusResults2P[playerId];
                break;
            case BATTLE:
...
void func_800A6E94(s32 playerCount, s32 playerId, u8* placeAry) {
    ...
    // nmi_gVersusResults3P for 3p, nmi_gVersusResults4P for 4p
    tally = (gPlayerCountSelection1 == 3) ? nmi_gVersusResults3P : nmi_gVersusResults4P;
